 ...
 */
package nl.cypherpunk.modifiedcache.dag;
...
public class IncrementalMealyDAGBuilder<I, O> extends
	 ...
	 * <tt>null</tt> if no information about the input word is present.
	 * 
	 * @param word
	 *            the input word
	 ...
	 * @return <tt>true</tt> if the information contained was complete (in this
	 *         case, <code>word.length() == output.size()</code> will hold),
	 ...
	 */
	@Override
	public void insert(Word<? extends I> word, Word<? extends O> outputWord) throws ConflictException {
		int len = word.length();
